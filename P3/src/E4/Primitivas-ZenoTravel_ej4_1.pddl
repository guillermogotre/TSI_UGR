(:durative-action board
 ...
 :effect (and  (not (at ?p ?c))
               (in ?p ?a)
               (decrease (board-limit ?a) 1)
               ;(increase (etime ?a) (boarding-time))
        )
)
...
(:durative-action debark
 ...
 :effect (and  (not (in ?p ?a))
               (at ?p ?c)
               (increase (board-limit ?a) 1)
               ;(increase (etime ?a) (debarking-time))
         )
)
...
(:durative-action fly 
 ...
 :effect (and  (not (at ?a ?c1))
              ...
              (decrease (fuel ?a) 
                         (* (distance ?c1 ?c2) (slow-burn ?a)))
                ;(increase (etime ?a) (/ (distance ?c1 ?c2) (slow-speed ?a)))
        )
)
...
(:durative-action zoom
 ...
 :effect (and (not (at ?a ?c1))
              ...
              (decrease (fuel ?a) 
                         (* (distance ?c1 ?c2) (fast-burn ?a)))
                ;(increase (etime ?a) (/ (distance ?c1 ?c2) (fast-speed ?a)))
        )
)
